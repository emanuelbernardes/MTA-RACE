...
function enableContrast()
	...
	-- Shaders
	contrastShader = dxCreateShader( "files/data/options/hdr/fx/contrast.fx" )
	bloomCombineShader = dxCreateShader( "files/data/options/hdr/fx/bloom_combine.fx" )
	bloomExtractShader = dxCreateShader( "files/data/options/hdr/fx/bloom_extract.fx" )
	blurHShader = dxCreateShader( "files/data/options/hdr/fx/blurH.fx" )
	blurVShader = dxCreateShader( "files/data/options/hdr/fx/blurV.fx" )
	modulationShader = dxCreateShader( "files/data/options/hdr/fx/modulation.fx" )
	...
	-- Overlay texture
	textureVignette = dxCreateTexture ( "files/data/options/hdr/images/vignette1.dds" );
